...
namespace TrinhNgocVan.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeeController : ControllerBase
    {
        private readonly EAP_Exam_TrinhNgocVanContext _context;

        public EmployeeController(EAP_Exam_TrinhNgocVanContext context)
        {
            _context = context;
        }
